...
@SessionAttributes({SESSION_CUSTOMER, SESSION_USER})
public class CustomerAccountController {
    ...
    public String getUsers(Principal principal, Model model) {
        ...
        UserDto user = userService.getUserFromSession(principal);
    ...
    public String updatePassword(Principal principal, String password) {
        UserDto currentUser = userService.getUserFromSession(principal);
    ...
    public String updateCustomer(@SessionAttribute(SESSION_USER) UserDto sessionUser, CustomerDto updateCustomer) {
        CustomerDto sessionCustomer = customerService.findByUsername(sessionUser.getUsername());
        customerUpdating.saveOrUpdateCustomer(updateCustomer, sessionCustomer);
